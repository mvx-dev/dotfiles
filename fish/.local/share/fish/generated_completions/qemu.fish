...
complete -c qemu -o mon -d 'Set up a monitor connected to the chardev name'
...
complete -c qemu -o singlestep -d 'This is a deprecated synonym for the TCG accelerator property one-insn-per-tb'
...
complete -c qemu -o chroot -d 'Deprecated, use \\(aq-run-with chroot=. \\(aq instead'
