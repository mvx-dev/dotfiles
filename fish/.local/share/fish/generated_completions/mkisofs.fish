...
complete -c mkisofs -o eltorito-boot -d 'Specifies the path and filename of the boot image to be used when making an E…'
...
complete -c mkisofs -o cdrecord-params -d 'This option is needed to create a CD Extra or the image of a second session o…'
complete -c mkisofs -o eltorito-catalog -d 'Specifies the path and filename of the boot catalog, which is required for an…'
...
complete -c mkisofs -o checksum_algorithm_iso -d 'Specify the checksum types desired for the output image'
complete -c mkisofs -o checksum_algorithm_template -d 'Specify the checksum types desired for the output jigdo template'
complete -c mkisofs -o copyright -d 'Specifies copyright information, typically a filename on the disc'
complete -c mkisofs -o omit-period -d 'Do not append a period to files that do not have one'
complete -c mkisofs -o disable-deep-relocation -d 'Do not use deep directory relocation, and instead just pack them in the way w…'
complete -c mkisofs -o debug -d 'Set debug flag'
...
complete -c mkisofs -o efi-boot -d 'Set EFI boot image name'
complete -c mkisofs -o follow-links -d 'Follow symbolic links when generating the filesystem'
...
complete -c mkisofs -o omit-version-number -d 'Omit version numbers from ISO9660 filenames'
...
complete -c mkisofs -o sectype -d 'Set output sector type to e. g.  data/xa1/raw'
...
complete -c mkisofs -o untranslated-filenames -d 'Allows "untranslated" filenames, completely violating the ISO9660 standards d…'
...
complete -c mkisofs -o XA -d 'Generate XA directory attruibutes'
complete -c mkisofs -o xa -d 'Generate rationalized XA directory attruibutes'
...
complete -c mkisofs -s D
complete -c mkisofs -s e
complete -c mkisofs -s f
complete -c mkisofs -s l
complete -c mkisofs -s N -d 'as the extra name space is taken from the space reserved for file version num…'
...
complete -c mkisofs -s z
complete -c mkisofs -o transparent-compression -d 'Generate special RRIP records for transparently compressed files'
