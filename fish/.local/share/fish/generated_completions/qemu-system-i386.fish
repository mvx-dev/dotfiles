...
complete -c qemu-system-i386 -o mon -d 'Set up a monitor connected to the chardev name'
...
complete -c qemu-system-i386 -o singlestep -d 'This is a deprecated synonym for the TCG accelerator property one-insn-per-tb'
...
complete -c qemu-system-i386 -o chroot -d 'Deprecated, use \\(aq-run-with chroot=. \\(aq instead'
